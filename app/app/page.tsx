  ...
  return (
    <div>
      ...
      <div className="bg-primary-navy border-l-[5px] border-accent-red px-6 pt-10 pb-8 shadow-sm">
        <p className="text-lg text-white mb-1">Διαθέσιμο Υπόλοιπο</p>
        <AmountDisplay
      ...
      <div className="px-4 -mt-4 flex flex-col gap-3">
        ...
        <Card
          ...
          icon={
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M 9 10 l 2 2 l 4 -4 m 5 4 V 6 a 2 2 0 0 0 -2 -2 H 6 a 2 2 0 0 0 -2 2 v 12 l 3 -2 l 3 2 l 3 -2 l 3 2 z" />
            </svg>
          }
        />
      </div>
